...
const algoMastery = [
    ...
    { id: "Basic-04", name: "Thursday: Palindrome Checker", desc: "Implementing a logic to check if a word or sentence is spelled the same forward and backward, ignoring case and spaces.", path: "https://github.com/rajyabdullah-spec/JavaScript-Algorithms-Mastery/blob/main/01-Basic-Algorithms/Thursday-Palindrome.js", github: "https://github.com/rajyabdullah-spec/JavaScript-Algorithms-Mastery" }
];
